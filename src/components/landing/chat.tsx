          ...
          <div className="order-2 md:order-1">
            <div className="relative mx-auto max-w-xl">
              ...
              <p className="my-16 text-xl text-gray-700 dark:text-gray-300">
                Anaya lets you chat directly with your documents — so you can
                ask follow-up questions, clarify complex points, and surface
                insights on demand.
              </p>
          ...
          <div className="order-1 md:order-2 mx-auto">
            <div className="relative max-w-lg">
              ...
              <div className="relative rounded-2xl border-2 border-black bg-white overflow-hidden ring-1 ring-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:shadow-gray-900/30 dark:ring-gray-700">
                <Image
                  src="https://raw.githubusercontent.com/sandip-pathe/projects/refs/heads/main/7.png"
