          ...
          <div className="order-2 md:order-2">
            <div className="max-w-xl mx-auto">
              ...
              <p className="my-16 md:my-8 lg:my-12 text-lg sm:text-xl text-gray-700 dark:text-gray-300">
                Anaya identifies and extracts critical data points from your
                documents, presenting them in a structured and visual format.
                Never miss a deadline or key piece of information again.
              </p>
              <ul className="space-y-4 sm:space-y-6">
                {features.map((feature, index) => (
                  ...
                  >
                    <span className="ml-1 text-md sm:text-xl md:text-2xl dark:text-gray-300">
                      {feature}
                    </span>
                  </li>
                ))}
